        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Join thousands of users earning coins with PDF tools
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-gradient-to-r from-primary-500 to-secondary-500 text-white py-3 px-4 rounded-lg hover:from-primary-600 hover:to-secondary-600 transition-colors font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
          ...
          <div className="mt-6 p-4 bg-gradient-to-r from-primary-50 to-secondary-50 dark:from-primary-900/20 dark:to-secondary-900/20 rounded-lg border border-primary-200 dark:border-primary-800">
            ...
            <ul className="text-sm text-gray-700 dark:text-gray-300 space-y-1">
              <li>• 🪙 Earn coins for every tool you use</li>
              <li>• 🎁 Redeem for Google Play codes & UPI money</li>
              <li>• 🏆 Unlock achievements and compete on leaderboards</li>
              <li>• 🔒 100% secure and private file processing</li>
            </ul>
          </div>
        </motion.div>
      </div>
